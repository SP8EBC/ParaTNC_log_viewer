...
class SerialIo {
  public:
	 ...
	 * definition is used here and in the embedded side in the controller. Embedded code, which persist
     * any new event on the controller side is here: https://github.com/SP8EBC/ParaTNC/blob/master/src/nvm/nvm_event.c
     * @warning each log entry is protected by a CRC checksum calculated by implementation in ./src/shared/crc_.c
