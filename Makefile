OBJS := ./src/main.o ./src/serial_io.o ./src/shared/crc_.o ./src/shared/event_log_to_string.o ./wjwwood_serial/src/serial.o ./wjwwood_serial/src/impl/unix.o
DEFINES := -DSPDLOG_ACTIVE_LEVEL=SPDLOG_LEVEL_DEBUG
INCLUDES := -I/usr/include/spdlog -I ./wjwwood_serial/include -I./src/shared -I.
...
clean:
	...
	rm -rf -- ./src/*.d ./src/*.o ./src/shared/*.d ./src/shared/*.o
